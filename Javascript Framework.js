...
JFramework.prototype = {
	...
	get : function(tid){
		...
		if(str[0] == 'success'){
			...
			o.id  = 'editor_'+tid;
			o.innerHTML = '<input class="input" type="text" size="40" maxLength="100" value="'+str[1]+'" /> <a onclick="subject.save(\''+tid+'\')" class="bta">儲存</a><a onclick="subject.cancle(\''+tid+'\')" class="bta">取消</a>';
			var obj = getObj('a_ajax_'+tid);
